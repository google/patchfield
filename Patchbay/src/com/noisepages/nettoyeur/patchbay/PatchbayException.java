...
/**
 * Checked exception for Java-style handling of error codes from Patchbay. The
 * {@link Patchbay} class itself doesn't throw exceptions but returns C-style
 * error codes because exceptions can't be thrown via AIDL. If, however, you
 * prefer to use exceptions in Java, you can convert error codes by wrapping
 * calls to Patchbay in the throwOnError method below.
 */
